...
public class bluefilecontrol extends Activity{
	...
	Handler h_one = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			if(result.equals("CONNECT OK")){
				Toast.makeText(bluefilecontrol.this, "连接成功", Toast.LENGTH_SHORT).show();
			}
			else if(result.equals("CONNECT FALSE")) {
				Toast.makeText(bluefilecontrol.this, "连接失败", Toast.LENGTH_SHORT).show();
			}
			else if(result.equals("SENDING")){
				
				Toast.makeText(bluefilecontrol.this, "开始传输数据", Toast.LENGTH_SHORT).show();
			}
			else if(result.equals("SENDED")) {
				Toast.makeText(bluefilecontrol.this, "数据传输完毕", Toast.LENGTH_SHORT).show();
			}
		}
	...
	protected void onCreate(Bundle savedInstanceState) {
	        ...
	        setContentView(R.layout.bluefilecontrol);  
	...
	private BroadcastReceiver mReceiver = new BroadcastReceiver(){
 	...
 	private OnItemClickListener deviceConnectListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
			...
			if(address.equals("*****************"))
			{
				Toast.makeText(bluefilecontrol.this, "地址无效", Toast.LENGTH_SHORT).show();
			}
			else {
				Toast.makeText(bluefilecontrol.this, "正在连接蓝牙", Toast.LENGTH_SHORT).show();
	...
	private OnClickListener sendListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			if(isFileBoolean)
			{
				...
				Toast.makeText(bluefilecontrol.this, "请选择文件", Toast.LENGTH_SHORT).show();
			}
